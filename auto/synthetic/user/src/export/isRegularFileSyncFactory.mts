import {implementation, type AnioJsDependencies} from "#~synthetic/async.sync/isRegularFileSync.mts"
...
declare function isRegularFileSync(
	input_path: string
) : boolean

/**
 * @brief
 * Create an instance of the function 'isRegularFileSync'.
 *
 * @param user
 ...
 *
 * @return
 * An instance of the function 'isRegularFileSync'.
 */
export function isRegularFileSyncFactory(context: RuntimeWrappedContextInstance) : typeof isRegularFileSync {
	...
	return function isRegularFileSync(input_path: string) : boolean {
