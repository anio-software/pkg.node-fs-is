import {implementation, type AnioJsDependencies} from "#~synthetic/async.sync/isSymbolicLink.mts"
...
declare function isSymbolicLink(
	input_path: string
) : Promise<boolean>

/**
 * @brief
 * Create an instance of the function 'isSymbolicLink'.
 *
 * @param user
 ...
 *
 * @return
 * An instance of the function 'isSymbolicLink'.
 */
export function isSymbolicLinkFactory(context: RuntimeWrappedContextInstance) : typeof isSymbolicLink {
	...
	return async function isSymbolicLink(input_path: string) : Promise<boolean> {
