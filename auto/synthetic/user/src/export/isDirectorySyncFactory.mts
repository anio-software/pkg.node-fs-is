import {implementation, type AnioJsDependencies} from "#~synthetic/async.sync/isDirectorySync.mts"
...
declare function isDirectorySync(
	input_path: string
) : boolean

/**
 * @brief
 * Create an instance of the function 'isDirectorySync'.
 *
 * @param user
 ...
 *
 * @return
 * An instance of the function 'isDirectorySync'.
 */
export function isDirectorySyncFactory(context: RuntimeWrappedContextInstance) : typeof isDirectorySync {
	...
	return function isDirectorySync(input_path: string) : boolean {
