import {implementation, type AnioJsDependencies} from "#~synthetic/async.sync/isFile.mts"
...
/**
 * @brief
 * Create an instance of the function 'isFile'.
 *
 * @param user
 ...
 *
 * @return
 * An instance of the function 'isFile'.
 */
export function isFileFactory(context: RuntimeWrappedContextInstance) : typeof isFile {
	...
	return async function isFile(input_path: string) : Promise<boolean> {
