import {implementation, type AnioJsDependencies} from "#~synthetic/async.sync/isRegularDirectory.mts"
...
declare function isRegularDirectory(
	input_path: string
) : Promise<boolean>

/**
 * @brief
 * Create an instance of the function 'isRegularDirectory'.
 *
 * @param user
 ...
 *
 * @return
 * An instance of the function 'isRegularDirectory'.
 */
export function isRegularDirectoryFactory(context: RuntimeWrappedContextInstance) : typeof isRegularDirectory {
	...
	return async function isRegularDirectory(input_path: string) : Promise<boolean> {
