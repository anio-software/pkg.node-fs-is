import {implementation, type AnioJsDependencies} from "#~synthetic/async.sync/isRegularFile.mts"
...
declare function isRegularFile(
	input_path: string
) : Promise<boolean>

/**
 * @brief
 * Create an instance of the function 'isRegularFile'.
 *
 * @param user
 ...
 *
 * @return
 * An instance of the function 'isRegularFile'.
 */
export function isRegularFileFactory(context: RuntimeWrappedContextInstance) : typeof isRegularFile {
	...
	return async function isRegularFile(input_path: string) : Promise<boolean> {
